...
/* Function declarations for TS_REQ defined in EXP/ts_req_print.c */

int TS_REQ_print_bio(BIO *bio, TS_REQ *a);

/* Function declarations for TS_RESP defined in EXP/ts_resp_utils.c */
...
/*
 * Declarations related to response generation, defined in EXP/ts_resp_sign.c.
 */
 ...
 * they are defined in EXP/ts_resp_verify.c.
 */
...
/* Function declarations for TS_RESP defined in EXP/ts_resp_print.c */

int TS_RESP_print_bio(BIO *bio, TS_RESP *a);
int TS_STATUS_INFO_print_bio(BIO *bio, TS_STATUS_INFO *a);
int TS_TST_INFO_print_bio(BIO *bio, TS_TST_INFO *a);

/* Common utility functions defined in EXP/ts_lib.c */
